<template>
	<view class="template-king tn-safe-area-inset-bottom">
		...
		<view>
			<!-- <view class="">
				<view class="slideshow">
					<view class="slideshow-image"
						style="background-image: url('https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683551116291-assets/web-upload/c4c0d31c-88ee-42c7-99ba-139ef206aaed.jpeg')">
					</view>
					<view class="slideshow-image"
						style="background-image: url('https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1692940242423-assets/web-upload/6d82b929-67e4-4919-a826-c931940f5872.jpeg')">
					</view>
					<view class="slideshow-image"
						style="background-image: url('https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1692940242362-assets/web-upload/39542345-83ab-456c-b309-e156174d5561.jpeg')">
					</view>
					<view class="slideshow-image"
						style="background-image: url('https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1692940242375-assets/web-upload/72155ffc-795c-4cc4-b4b5-171fbb44ab8d.jpeg')">
					</view>
				</view>
				<view class="beibei">
					<view class="beibei2"
						style="background-image: url('https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1692940242375-assets/web-upload/72155ffc-795c-4cc4-b4b5-171fbb44ab8d.jpeg')">
						<view class=""
							style="width: 100%;height: 1000upx;background: linear-gradient(0deg, rgba(0,0,0,0.8), rgba(0,0,0,0),  rgba(0,0,0,0), rgba(0,0,0,0));position: absolute;bottom: 0;z-index: 99;">
							<view class="tn-padding tn-color-white" style="position: absolute;bottom: 0;">
								<view class="tn-flex tn-flex-col-center tn-flex-row-left tn-padding-right">
									<view class="justify-content-item">
										<text class='tn-text-xxl tn-padding-right tn-text-bold'>不许凶我吖</text>
									</view>
								</view>
								<view class="tn-flex tn-padding-right tn-padding-top-xs">
									<view class="justify-content-item">
										<view class="tag-user" style="font-size: 20rpx;">
											<text class="" style="">软件行业 · 高级UI设计师</text>
										</view>
									</view>
								</view>
								<view class="tn-flex tn-padding-right tn-padding-top-xs">
									<view class="justify-content-item tn-margin-right-xs">
										<view class="tag-user tn-bg-purplered--light tn-color-purplered--dark"
											style="font-size: 16rpx;">
											<text class="tn-icon-sex-female"></text>
											<text class="" style="padding-left: 4rpx;">26</text>
										</view>
									</view>
									<view class="justify-content-item">
										<view class="tag-user" style="font-size: 16rpx;">
											<text class="" style="">浙江</text>
										</view>
									</view>
									<view class="justify-content-item">
										<view class="tag-user" style="font-size: 16rpx;">
											<text class="" style="">双鱼座</text>
										</view>
									</view>
									<view class="justify-content-item">
										<view class="tag-user" style="font-size: 16rpx;">
											<text class="" style="">12.9 km</text>
										</view>
									</view>
								</view>
							</view>
			...
			<view class="template-index tn-safe-area-inset-bottom card-swiper">
				<view class="swiper-item1 image-banner tn-shadow-blur"
					style="background-image:url(https://resource.tuniaokj.com/images/resume/resume-bg.jpg);width: 750rpx;height: 100%;background-size: cover;">
				</view>
				<view class="swiper-item2 image-banner tn-shadow-blur"
					style="ackground-image:url(https://resource.tuniaokj.com/images/blogger/blogger_beibei.jpg);width: 120rpx;height: 120rpx;background-size: cover;">
				</view>
				<view class="swiper-item-text tn-text-shadow-indigo">
					<view class="tn-text-bold tn-color-blue--dark" style="font-size: 45rpx;">徐圆圆</view>
					<view class="tn-color-blue--dark tn-padding-top-sm">UI设计师</view>
					<view class="tn-flex tn-padding-top-xl" style="margin-left: -50rpx;">
						<view class="tn-flex-1 tn-padding-sm tn-margin-right">
							<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
								<view class="">
									<view class="tn-text-xxl tn-color-blue">964</view>
								</view>
						...
						<view class="tn-flex-1 tn-padding-sm tn-margin-left tn-margin-right">
							<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
								<view class="">
									<view class="tn-text-xxl tn-color-orange">94</view>
								</view>
								<view class="tn-margin-top-xs tn-color-grey tn-text-df tn-text-center">
									<text class="tn-icon-inventory"></text>
									<text class="tn-padding-left-xs">接单量</text>
								</view>
							</view>
						</view>
						<view class="tn-flex-1 tn-padding-sm tn-margin-left">
							<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
								<view class="">
									<view class="tn-text-xxl tn-color-red">186</view>
								</view>
								<view class="tn-margin-top-xs tn-color-grey tn-text-df tn-text-center">
									<text class="tn-icon-like"></text>
									<text class="tn-padding-left-xs">好评量</text>
								</view>
							</view>
						</view>
					</view>
			...
			<view class="king-list tn-margin-top-sm">
				...
				<view class="king-icon">
					<text class='tn-icon-creative tn-color-white tn-text-lg tn-bg-purple tn-round tn-padding-xs'></text>
				...
				<view class="king-icon">
					<text class='tn-icon-company tn-color-white tn-text-lg tn-bg-purple tn-round tn-padding-xs'></text>
				...
				<view class="king-icon">
					<text class='tn-icon-trophy tn-color-white tn-text-lg tn-bg-purple tn-round tn-padding-xs'></text>
				...
				<view class="king-icon">
					<text class='tn-icon-honor tn-color-white tn-text-lg tn-bg-purple tn-round tn-padding-xs'></text>
              ...
              <text>东东工作室</text>
				...
				<view class="king-icon">
					<text class='tn-icon-brand tn-color-white tn-text-lg tn-bg-purple tn-round tn-padding-xs'></text>
				...
				<view class="king-icon">
					<text class='tn-icon-tag tn-color-white tn-text-lg tn-bg-purple tn-round tn-padding-xs'></text>
					...
					<view class="resume">
						...
						<view class="tn-tag-content tn-text-justify">
							<view v-for="(item, index) in tagList" :key="index"
								...
								<text class="tn-tag-content__item--prefix tn-icon-spiral"></text> {{ item.title }}
							</view>
						</view>
			...
			<view class="tn-flex tn-footerfixed">
				<view
					class="tn-flex-1 justify-content-item tn-margin-left tn-margin-right-xs tn-text-center tn-bg-white"
					style="border-radius: 100rpx;">
					<tn-button backgroundColor="#8A5BF1 " padding="39rpx 0" width="100%" :fontSize="28" :plain="true"
						fontColor="#8A5BF1" shape="round" @click="tn('')">
						<text class="tn-icon-starry tn-padding-right-sm"></text>
						<text class="">收藏</text>
					</tn-button>
				</view>
				<view class="tn-flex-1 justify-content-item tn-margin-right tn-margin-left-xs tn-text-center">
					<tn-button backgroundColor="#8A5BF1 " padding="40rpx 0" width="100%" :fontSize="28"
						fontColor="#FFFFFF" shape="round" @click="tn('')">
						<text class="tn-icon-meteor-fill tn-padding-right-sm"></text>
						<text class="">留言</text>
					</tn-button>
				</view>
			</view>
			...
			<!-- 图鸟点击动画-->
			<!-- <view class="" @click="clickHandler" bindtouchstart="likeTouchStart" bindtouchend="likeTouchEnd">
				<view class="icon15__item--icon tn-flex tn-flex-row-center tn-flex-col-center tn-shadow-blur button-dd">
			...
			<view class="template-bubble" style="z-index: 9999;">
	...
	export default {
		...
		data() {
			return {
				...
				count: 0, // 点赞新的
				likeClickInterTime: null, // 定时执行弹出动画定时器
				...
				groupList: [{
					...
					{
						src: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1692940242356-assets/web-upload/56934be9-5a8d-46ef-8bfa-4159c3a3cef8.jpeg'
					},
				],
		...
		methods: {
			...
			generateBubble() {
				...
				const image = "https://resource.tuniaokj.com/images/like/" + this.$t.number.randomInt(1, 24) + ".png"
				uni.getImageInfo({
					src: image,
					success: (res) => {
			...
			bubbleAnimate() {
				...
				Object.keys(this.queue).forEach(key => {
					...
					curAlpha = y / (1 * height) //消失的高度适当调一下
